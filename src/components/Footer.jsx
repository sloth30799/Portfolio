...
const Footer = () => {
  return (
    <footer className="footer p-10 bg-base-200 text-base-content">
      ...
      <div>
        <span className="font-title">Navigation</span>
        <Link to="/" className="link link-hover font-semibold text-xs">
          Home
        </Link>
      ...
      <div>
        <span className="font-title">Social</span>
        <a
        ...
        <a
          className="link link-hover font-semibold text-xs"
          href="https://github.com/sloth30799"
          target="_blank"
        >
          Github
        </a>
